...
export const projects: Project[] = [
  ...
  {
    slug: "lt-finance-equity-research",
    title: "L&T Finance Holdings – Equity Research (NBFC)",
    summary:
      "Comprehensive NBFC sector and company-level equity research on L&T Finance Holdings, integrating financial analysis, peer benchmarking, and management concall insights.",
    tags: ["Equity Research", "NBFC", "Financial Analysis", "Valuation"],
    category: "Equity Research",
    details: [
      {
        description:
          "Approach: Conducted a full NBFC sector and company deep-dive, analyzing FY21–FY23 income statement, balance sheet, asset quality, and liquidity. Evaluated a ₹25.7L Cr balance sheet and ₹2.9L Cr total income while tracking improvement in cost of borrowing from 8.1% to 7.5%.",
        impact:
          "Identified recovery trends, balance-sheet resilience, and improving funding efficiency in a tightening credit environment."
      },
      {
        description:
          "Benchmarking: Compared L&T Finance against five major NBFC peers (Bajaj Finance, Shriram Finance, Aditya Birla Capital, Cholamandalam, HDFC AMC) using ROE, P/E, market capitalization, GNPA, and credit cost metrics.",
        impact:
          "Positioned L&T Finance as a diversified NBFC with improving asset quality and competitive relative valuation."
      },
      {
        description:
          "Outlook: Integrated earnings-concall insights including Lakshya 2026 strategy, digital underwriting initiatives, and customer growth momentum.",
        impact:
          "Developed a cautious but improving investment outlook supported by quantitative metrics and management guidance."
      }
    ],
    links: {
      report: "/reports/lt-finance-equity-research.pdf"
    },
    kpis: [
      { label: "Balance Sheet", value: "₹25.7L Cr" },
      { label: "Total Income", value: "₹2.9L Cr" },
      { label: "Cost of Borrowing", value: "8.1% → 7.5%" },
      { label: "Peers Benchmarked", value: "5" }
    ]
  },
  {
